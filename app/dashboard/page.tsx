    ...
    >
      ...
      >
                ...
                {[days, hours, minutes, seconds].map((time, index) => (
                  <Box
                    ...
                    sx={{
                      ...
                      minWidth: '130px', // Ensure each box has a minimum width
                      maxWidth: '25%', // Limit to 4 boxes in a row
                    }}
                  >
                    <Typography
                      variant="h3"
                    ...
                    <Typography
                      variant="body1"
                      sx={{
                        fontSize: { xs: 'sm', sm: 'base', lg: 'lg' }, // Adjust label size responsively
                      }}
                    >
        ...
        <Box sx={{ mt: 6, display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          <Typography
            variant="body1"
            sx={{ opacity: 0.75, fontSize: { xs: 'sm', sm: 'base' } }}
          >
